 ...
 * Touch with a ripple.
 * @module  lib/Ripple
 * @version 8.1488.3-20190714
 * @license Apache-2.0
 */

/**
 * Pollyfill for w3c events.
 * @enum {String}
 */
const eNames = {
  pointerdown: PointerEvent ? 'pointerdown' : 'mousedown',
  pointerup: PointerEvent ? 'pointerup' : 'mouseup',
}

/**
 * Can be reset by using Ripple.set at anytime. **Experimental**
 * @namespace
...
[${mark}]::after {
  ...
  width: var(${propName('rippleDiameter')}, 60px);
  height: var(${propName('rippleDiameter')}, 60px);
